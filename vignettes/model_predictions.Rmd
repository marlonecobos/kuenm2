...
Once selected models have been fit using `fit_selected()`, projections to single or multiple scenarios can be performed. The function `predict_selected()` is designed for projections to single scenarios.
