...
To start the calibration process, we need a `prepared_data` object. For more details in data preparation, please refer to [Prepare Data for Model Calibration vignette](prepared_data.Rmd).
