...
In this example, we'll fit the final models using the same replicate settings (4-fold cross-validation) as used in the [Model Calibration](model_calibration.html) vignette.
