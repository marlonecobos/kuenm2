...
climatic conditions (2041-2060) based on the MIROC6 General Circulation
Model under the SSP126 scenario. The variables were obtained at a 10
arc-minute resolution and masked using the `m` region provided in the
package. Data sourced from WorldClim:
