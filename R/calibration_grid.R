#COLOCAR CALIBRATION GRID JUNTO COM PREPARE DATA!!!
...
#' @export
#' @usage calibration_grid(swd = NULL, var_names = NULL, min_number = 2,
#'                         min_continuous = NULL, categorical_var = NULL,
...
#' g <- calibration_grid(swd = sp_swd, var_names = NULL, min_number = 2,
#'                       min_continuous = NULL,
#'                       categorical_var = "SoilType",
#'                       features = c("l", "q", "lq", "lqp", "p"),
#'                       model_type = "glmnet",
#'                       regm = c(0.1, 1, 2, 3, 5),
#'                       write_file = FALSE,
