...
To maintain high standards of code quality and documentation, we used AI LLM tools for algorithmic refinement, grammatical polishing, and exploring technical implementation strategies for specialized functions. All final code and documentation are manually vetted by the maintainers.
